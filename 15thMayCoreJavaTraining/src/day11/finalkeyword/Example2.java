...
public class Example2 {
	...
	public static void main(String[] args) {
		...
		//age=50;//you will get compile time error as final/constant variable value can;t be re-initialize
		System.out.println("Age: "+age);
...
Local constant variable: variable should be declare with final keyword and should be initialize only once
						before use
