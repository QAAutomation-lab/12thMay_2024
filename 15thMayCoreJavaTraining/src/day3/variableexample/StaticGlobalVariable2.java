...
public class StaticGlobalVariable2 {
	...
	public static void main(String[] args) {
		...
		System.out.println("SGV age: "+StaticGlobalVariable2.age);//25
		System.out.println("SGV salary: "+StaticGlobalVariable2.salary);//0.0
		System.out.println("SGV status: "+StaticGlobalVariable2.status);
		StaticGlobalVariable2.age=50;
		StaticGlobalVariable2.salary=555000.5;
		StaticGlobalVariable2.status=true;
		System.out.println("updated, SGV age: "+StaticGlobalVariable2.age);//50
		System.out.println("updated, SGV salary: "+StaticGlobalVariable2.salary);//555000.5
		System.out.println("updated, SGV status: "+StaticGlobalVariable2.status);
